...
from encoder_att_decoder import Encoder, Decoder, Seq2Seq
...
class Lipreading(nn.Module):
    def __init__(self, mode, hiddenDim=512, embedSize=256, nClasses=53):
...
def lipreading(mode, hiddenDim=512, nClasses=53):
